...
import { PaymentStatusPayload } from '../../../features/events/event.types';

@Injectable()
export class PaymentFailedHandler extends BaseKafkaEventHandler<PaymentStatusPayload> {
  readonly eventType = PaymentKafkaTopics.PAYMENT_FAILED;
