...
@Injectable()
export class DriverAssignmentOfferedHandler extends BaseKafkaEventHandler<any> {
  readonly eventType = DriverEventType.AssignmentOffered;
  readonly natsSubject = RealtimeNatsSubjects.DRIVER_ASSIGNMENT_OFFERED;
